...
$string['migrate:usersettings'] = 'Migrate user settings (favorite, private order) from block_semestersortierung to block_semsort';
...
$string['migrate:adminsettings'] = 'Migrate admin settings from block_semestersortierung to block_semsort';
