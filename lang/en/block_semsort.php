...
$string['migrate2_title'] = 'Migrate settings back to semester_sortierung block';
$string['migrate'] = 'Migrate settings';
$string['migrate:results'] = '<strong>Migration complete:</strong><br />';
$string['migrate:defaultdashboard'] = 'Replace block_semester_sortierung with block_semsort on default dashboardpage';
...
$string['migrate:alldashboards'] = 'Replace block_semester_sortierung with block_semsort on all users dashboardpages';
...
$string['migrate:usersettings'] = 'Migrate user settings (favorite, private order) from block_semester_sortierung to block_semsort';
$string['migrate:usersettings_help'] = 'By selecting this checkbox, the migration script will copy all users\' personal settings from block_semester_sortierung to block_semsort. Personal users settings are courses marked as favorite, order of courses inside semester boxes, and expanded courses/semesters.  For testing purposes, this option can be executed only for the current user.';
$string['migrate:adminsettings'] = 'Migrate admin settings from block_semester_sortierung to block_semsort';
...
$string['migrate:defaultdashboard2'] = 'Replace block_semsort with block_semester_sortierung on default dashboardpage';
$string['migrate:defaultdashboard2_help'] = 'By selecting this checkbox, the migration script will replace block_semsort instance with a block_semester_sortierung instance on the <strong>Default Dashboard page</strong>. Here, both "Migrate for current user only" and "Migrate for all users" have the same effect.';
$string['migrate:alldashboards2'] = 'Replace block_semsort with block_semester_sortierung on all users dashboardpages';
$string['migrate:alldashboards2_help'] = 'By selecting this checkbox, the migration script will replace all block_semsort instances with block_semester_sortierung instances on <strong>all Dashboard pages</strong> except for the Default Dashboard page. For testing purposes, this option can be executed only for the current user.';
$string['migrate:usersettings2'] = 'Migrate user settings (favorite, private order) from block_semsort to block_semester_sortierung';
$string['migrate:usersettings2_help'] = 'By selecting this checkbox, the migration script will copy all users\' personal settings from block_semsort tp block_semester_sortierung. Personal users settings are courses marked as favorite, order of courses inside semester boxes, and which courses are expanded.  For testing purposes, this option can be executed only for the current user.';
$string['migrate:adminsettings2'] = 'Migrate admin settings from block_semsort to block_semester_sortierung';
$string['migrate:adminsettings2_help'] = 'By selecting this checkbox, the migration script will copy (and replace) all admin settings from block_semsort to block_semester_sortierung. Here, both "Migrate for current user only" and "Migrate for all users" have the same effect.';
