...
class migrateform extends moodleform {
    protected function definition() {
        $mform = &$this->_form;
        $mform->addElement('checkbox', 'defaultdashboard', get_string('migrate:defaultdashboard2', 'block_semsort'));
        $mform->addHelpButton('defaultdashboard', 'migrate:defaultdashboard2', 'block_semsort');
        $mform->addElement('checkbox', 'alldashboards', get_string('migrate:alldashboards2', 'block_semsort'));
        $mform->addHelpButton('alldashboards', 'migrate:alldashboards2', 'block_semsort');
        $mform->addElement('checkbox', 'usersettings', get_string('migrate:usersettings2', 'block_semsort') );
        $mform->addHelpButton('usersettings', 'migrate:usersettings2', 'block_semsort');
        $mform->addElement('checkbox', 'adminsettings', get_string('migrate:adminsettings2', 'block_semsort'));
        $mform->addHelpButton('adminsettings', 'migrate:adminsettings2', 'block_semsort');
...
$PAGE->set_url(new moodle_url('/blocks/semsort/db/migrate2.php'));

$PAGE->set_pagelayout('admin');
$PAGE->set_heading(get_string('migrate2_title', 'block_semsort'));
$PAGE->set_title(get_string('migrate2_title', 'block_semsort'));
